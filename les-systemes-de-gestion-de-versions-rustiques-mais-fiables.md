...
sidebar:
  ...
  order: 1
prev: false
next: /utiliser-les-branches-des-systemes-de-gestion-de-sources
---

Travailler sur des fichiers sources au format texte, et non binaire, est l'occasion pour le de gérer son contenu comme les développeurs gèrent leur code : sous un système de gestion des sources tel que [Git](), Subversion ou SourceSafe.
...
:   Dépôt principal conservant toutes les versions des fichiers placées au cours du temps par le (ou plus fréquemment, le développeur).
