...
Par défaut, n\'insère pas automatiquement dans les fichiers PDF le texte *Exemple :* devant le titre d\'un exemple contenu entre balises `<example>`{.interpreted-text role="samp"}. La syntaxe [XSL-FO]() offre cependant cette possibilité.
:::
...
1.  Remplacez dans la feuille de style `plugins/org.dita.pdf2/xsl/fo/commons.xsl`{.interpreted-text role="file"} (sous 1.7.) le template suivant :
