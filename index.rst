...
source. Il est réalisé à partir de fichiers sources en format texte à balisage
léger de type Wiki ou Markdown (`reStructuredText
<http://docutils.sourceforge.net/docs/ref/rst/restructuredtext.html>`_). Il est
géré sous le logiciel de gestion de versions décentralisé `Git
