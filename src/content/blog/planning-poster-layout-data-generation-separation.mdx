...
> **The principle at work:** each fact lives in exactly one place. Not "one file per update" — one location per fact. The three YAML files are three categories of fact, not three copies of the same information.
