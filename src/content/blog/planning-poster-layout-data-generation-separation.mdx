...
snippet: "How a strict three-layer architecture — pure YAML data, a Python generator, and a LaTeX layout with no hardcoded values — ensures every fact lives in exactly one place, so a year's update means editing YAML only, never the layout."
image: {
