...
> **The principle at work:** each fact lives in exactly one place. Not "one file per update" — one location per fact. The three data YAML files are three categories of fact, not three copies of the same information.
...
- The planning poster is produced from four YAML files, a Python generator, and a LaTeX layout file with no hardcoded data.
