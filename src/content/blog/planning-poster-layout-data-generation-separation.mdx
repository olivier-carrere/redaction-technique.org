...
**Generation layer.** A single Python script that reads the five YAML files and writes into the language subdirectory to avoid collisions when building multiple editions sequentially:
