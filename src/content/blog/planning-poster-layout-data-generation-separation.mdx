...
flowchart TD
    ...
    G --> ST[fr/retreats.tex<br/>temple sessions]
    G --> AS[fr/offsite.tex<br/>off-site sessions]
    G --> CE[fr/camp-ete-main.tex<br/>summer camp]
    G --> CP[fr/camp-ete-prix.tex<br/>pricing table]
    G --> CA[fr/camp-ete-argentine.tex<br/>Argentina camp]
...
- Five content fragments: temple sessions (`fr/retreats.tex`), off-site sessions (`fr/offsite.tex`), summer camp details (`fr/camp-ete-main.tex`), pricing table (`fr/camp-ete-prix.tex`), and Argentina camp (`fr/camp-ete-argentine.tex`).
...
`traduction.yaml` is outside this cycle — it changes only when a display label is reworded or a new language is added, neither of which happens annually.
