...
3. Sélection du document cible
   └── ex. « Modèle d'article de tâche » à l'adresse https://docs.redaction-technique.org/fr/toolkit/task-article-template/

4. GET https://docs.redaction-technique.org/fr/toolkit/task-article-template.md
