...
Cette page s'adresse aux développeurs de scripts, d'outils de recherche ou d'agents IA. Elle illustre la dernière étape de la progression décrite dans ce manuel : un contenu [structuré](/fr/tools-and-formats/) et [versionné](/fr/docs-as-code/) peut être servi à des programmes (Markdown, JSON, llms.txt) aussi bien qu'à des personnes.
