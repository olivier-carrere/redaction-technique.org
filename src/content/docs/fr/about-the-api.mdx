...
GET /schema.json
        ↓
Découverte des endpoints, des filtres et de la taxonomie
        ↓
GET /fr/index.json?contentType=task&fields=title,url,markdown,contentType
        ↓
Sélection du document cible (ex. « tutorials/auto-insert-data-dita-xml/ »)
        ↓
Lecture de l'URL `markdown` annoncée
        ↓
