...
| `/index.json`, `/en/index.json`, `/fr/index.json` | JSON | Un index de documents consultable par machine : titre, description, URL, nombre de mots, titres, tags, `pageType` et `contentType` pour chaque page, avec prise en charge du filtrage par paramètres d'URL. |
