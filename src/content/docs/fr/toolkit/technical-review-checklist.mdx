...
- [ ] Le style, le ton et la grammaire — c'est une relecture éditoriale, pas technique (voir l'[exemple de workflow de revue](../example-review-workflow/), qui sépare les deux).
- [ ] La conformité de la structure aux conventions internes — c'est une revue qualité documentaire (voir la [check-list de qualité documentaire](../documentation-quality-checklist/)).
