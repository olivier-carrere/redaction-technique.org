...
Utilisez cette structure quand le lecteur doit **faire** quelque chose avec un résultat concret et vérifiable — pas pour une explication de fond (utilisez le [modèle concept](../concept-article-template/)) ni pour une consultation de spécifications (utilisez le [modèle référence](../reference-article-template/)).
