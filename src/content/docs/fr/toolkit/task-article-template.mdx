...
:::tip[Modèle]
Ceci est un **point de départ à copier et adapter**, pas un exemple abouti. Pour une version remplie, voir [l'exemple de workflow docs-as-code](../example-docs-as-code-workflow/).
:::

Utilisez cette structure quand le lecteur doit **faire** quelque chose avec un résultat concret et vérifiable — pas pour une explication de fond (utilisez le [modèle concept](../concept-article-template/)).

```markdown
---
title: "<Titre à l'impératif, ex. 'Configurer X' ou 'Migrer Y vers Z'>"
