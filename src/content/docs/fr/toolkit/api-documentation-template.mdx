...
- Pour un exemple opérationnel de documentation publiée avec son contrat lisible par machine, voir [l'API de ce manuel](/fr/about-the-api/) : son `/schema.json` décrit chaque endpoint, et la page de référence ajoute les conseils d'usage que le schéma ne peut pas porter.
