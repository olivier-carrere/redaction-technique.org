...
:::tip[Modèle]
Ceci est un **point de départ à copier et adapter**, pas un exemple abouti. C'est une instance spécialisée du [modèle d'article référence](../reference-article-template/), adaptée à un endpoint d'API par page.
:::
