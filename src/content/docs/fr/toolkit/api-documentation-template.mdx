...
- Si l'API dispose d'un schéma consultable par machine (OpenAPI, JSON Schema), pointez vers lui plutôt que de dupliquer manuellement chaque champ qu'il définit déjà — les deux finiraient par diverger.
