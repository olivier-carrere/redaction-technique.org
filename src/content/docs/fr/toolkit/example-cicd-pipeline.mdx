...
Un pipeline au vert montre que le site se génère et que ses liens se résolvent ; il ne montre pas que la documentation est prête à être livrée avec une version du produit. Utilisez la [check-list de préparation à la mise en production](../release-readiness-checklist/) comme jalon de livraison.
