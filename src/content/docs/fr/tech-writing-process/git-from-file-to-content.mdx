...
gitGraph
    accTitle: Historique de commits entrelacés avant le rebase
    accDescr: Historique Git montrant cinq commits alternant entre corrections de texte et modifications de synopsis, avant leur réorganisation par rebase.
    commit id: "Texte 1"
...
<Mermaid code={`%%{init: {"themeVariables": {"fontFamily": "IBM Plex Sans Variable, sans-serif", "git0": "{{parentStroke}}", "commitLabelColor": "{{childText}}", "commitLabelBackground": "{{childFill}}", "tagLabelBackground": "{{parentFill}}", "tagLabelBorder": "{{parentStroke}}", "tagLabelColor": "{{parentText}}"}}}%%
gitGraph
    accTitle: Historique de commits regroupés après le rebase
    accDescr: Historique Git montrant deux commits après rebase, l'un regroupant toutes les corrections de texte et l'autre tous les changements de synopsis.
    commit id: "Texte"
    commit id: "Synopsis"`} />
**Historique Git**
