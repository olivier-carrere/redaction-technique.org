...
radar-beta
    title Formats sources : modularité, format et structuration
    accTitle: Formats sources selon la modularité, le format et la structuration sémantique
    accDescr: Diagramme radar comparant FrameMaker, DocBook et DITA XML sur trois axes : modularité, format texte et structuration sémantique. FrameMaker est peu modulaire, binaire et non structuré. DocBook est peu modulaire, mais textuel et structuré. DITA XML est fortement modulaire, textuel et structuré.
    axis modularite["Modularité"], texte["Format texte"], structuration["Structuration"]
    ...
    min 0
    showLegend true`} />
**Formats sources : modularité, format et structuration sémantique.**

Les formats sources peuvent être classés selon leur degré de modularité, leur format de fichier et leur structuration sémantique.
...
Indépendamment du contrôle de la mise en page, les formats diffèrent aussi selon qu'ils sont **structurés sémantiquement** — selon que le balisage encode le sens plutôt que l'apparence, comme le montre le diagramme radar ci-dessus.
