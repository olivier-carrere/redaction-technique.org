...
description: "Un script Python peut intervertir les mots d'une phrase pour en changer le style sans en modifier le sens — une démonstration ludique de la manipulation de texte en Python."
---
---
