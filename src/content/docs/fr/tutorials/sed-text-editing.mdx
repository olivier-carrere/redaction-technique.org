...
La même idée de permutation de mots n'a pas à rester dans le shell : on la retrouve avec les [expressions régulières en Python](../python-regular-expressions/) ou dans la [jourdainisation en ligne d'une tirade](../word-shuffling-python/). La voici en vrai Python, exécuté en direct dans cette page :
