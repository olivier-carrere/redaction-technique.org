...
Chaque commande ci-dessus exécutait GNU sed. Voici ce binaire même — compilé depuis son code source C en WebAssembly — qui exécute le vrai GNU sed, en direct dans cette page. Modifiez les phrases et reformulez-les vous-même :

<SedMoliere lang="fr" />

La même idée de permutation de mots n'a pas à rester dans le shell. La voici en vrai Python, exécuté en direct dans cette page :
