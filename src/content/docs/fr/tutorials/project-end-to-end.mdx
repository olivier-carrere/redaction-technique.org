...
![Schéma du flux de travail de la galerie photo : photographes, iconographes et graphistes utilisant Piwigo](/assets/schema-galerie.svg)
...
![Flux de gestion des photos Piwigo montrant les rôles : le photographe téléverse, l'iconographe indexe, le graphiste télécharge](/assets/workflow-photo-piwigo.svg)
