...
import PhotoWorkflowDiagram from '../../../../components/diagrams/PhotoWorkflowDiagram.astro';
import IncrementalBackupArchitectureDiagram from '../../../../components/diagrams/IncrementalBackupArchitectureDiagram.astro';
import PhotoWorkflowRolesSwimlaneDiagram from '../../../../components/diagrams/PhotoWorkflowRolesSwimlaneDiagram.astro';

:::note[Étude de cas]
Une étude de cas extérieure à la documentation technique : la photothèque d'une association, menée de la conception à la livraison. Elle illustre le volet gestion de projet du [processus documentaire](/fr/process/) : cadrage, conception du workflow, outillage et didacticiels vidéo pour les utilisateurs.
:::
...
![Comparaison visuelle de deux versions PDF compilées d'un document LaTeX montrant les modifications de mise en page et de contenu](/assets/latex-diff-pdf.svg)
...
- [Définition du projet](../../tech-writing-process/project-definition/)
