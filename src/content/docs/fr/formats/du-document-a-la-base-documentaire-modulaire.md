...
La plupart des entreprises sont réticentes à mettre en place des <abbr title="Content Management System">CMS</abbr>, outils dédiés aux workflows. Elles ont d'ailleurs parfois connu des échecs de mise en place de telles solutions part le passé.
...
**Voir aussi**
- [Git : du fichier au contenu](../../tech-writing-process/référentiel/git-du-fichier-au-contenu)
