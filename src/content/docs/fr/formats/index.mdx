...
import FormatStructuringDiagram from '../../../../components/diagrams/FormatStructuringDiagram.astro';
import SourcesToDeliverableDiagram from '../../../../components/diagrams/SourcesToDeliverableDiagram.astro';
...
<CardGrid stagger>
  <LinkCard title="Cas concrets d'utilisation de DITA XML" href="/fr/formats/dita-xml-case-studies/" description="L'utilisation quotidienne du format de rédaction structurée DITA XML sur des projets multilingues en tant que rédacteur technique m'a amené à développer certaines solutions et astuces que je vous livre ici." />
  <LinkCard title="Formats structurés et non structurés" href="/fr/formats/structured-vs-unstructured-formats/" description="Les informations contenues dans un document technique peuvent être catégorisées selon leur sens." />
  <LinkCard title="Une architecture documentaire trop complexe ?" href="/fr/formats/document-architecture-complexity/" description="DITA XML permet des gains de productivité en réduisant le volume source que le rédacteur technique crée, traduit et maintient, au prix d'une plus grande complexité." />
  <LinkCard title="Du document à la base documentaire modulaire" href="/fr/formats/modular-documentation/" description="Le format de rédaction structurée DITA XML propose de passer du modèle du livre à celui de la base documentaire modulaire." />
  <LinkCard title="Cas concret : documentation de NuFirewall" href="/fr/formats/nufirewall-case-study/" description="La documentation de NuFirewall, qui a été perçue par la presse comme un point fort du produit, a été réalisée sous DITA XML." />
</CardGrid>
