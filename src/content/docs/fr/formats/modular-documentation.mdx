...
<CardGrid>
  <Card title='<span role="heading" aria-level="3">Rédacteur technique</span>'>
  ...
  <Card title='<span role="heading" aria-level="3">Utilisateur</span>'>
...
<CardGrid>
  <Card title='<span role="heading" aria-level="3">Guide de l&apos;utilisateur</span>'>
    **Contenu :** Thèmes systématiquement organisés en concept et procédures pas à pas
  </Card>
  <Card title='<span role="heading" aria-level="3">Document de présentation</span>'>
    **Contenu :** Concepts
  </Card>
  <Card title='<span role="heading" aria-level="3">Quickstart</span>'>
    **Contenu :** Procédures pas à pas
  </Card>
  <Card title='<span role="heading" aria-level="3">Manuel de référence</span>'>
    **Contenu :** Informations de référence
  </Card>
</CardGrid>
...
- [Formats structurés et non structurés](../structured-vs-unstructured-formats/)
