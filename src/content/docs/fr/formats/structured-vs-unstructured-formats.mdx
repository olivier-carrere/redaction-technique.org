...
<CardGrid>
  <Card title='<span role="heading" aria-level="3">Minimalistes</span>'>
  ...
  <Card title='<span role="heading" aria-level="3">Complètes</span>'>
  ...
  <Card title='<span role="heading" aria-level="3">Cohérentes</span>'>
