...
If technical documentation uses consistent terminology, the effectiveness of full-text searching is reduced: if the **technical editor** has used only the term *directory*, readers searching for the word *folder* will miss the information they're looking for.
