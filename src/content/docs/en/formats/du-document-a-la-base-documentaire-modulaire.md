...
DITA XML files can also be easily centralized in a single repository, such as a <abbr title="Enterprise Content Management">ECM</abbr> system or a <abbr title="Version Control Software">VCS</abbr>. This approach preserves the company's intangible capital.
