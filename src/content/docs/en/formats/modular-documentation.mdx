...
- [Strong information typing without the XML overhead](https://redaction-technique.org/strong-information-typing-without-xml-overhead) — the modular, typed approach applied with lightweight tools.
