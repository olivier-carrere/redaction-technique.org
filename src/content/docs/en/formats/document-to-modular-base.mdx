...
DITA XML files can also be easily centralized in a [single repository](../tech-writing-process/un-referentiel-unique/), such as a <abbr title="Enterprise Content Management">ECM</abbr> system or a <abbr title="Version Control System">VCS</abbr>. This approach preserves the company's intangible capital.
...
- [Structured and unstructured formats](../formats-structures-et-non-structures/)
