...
- [From DITA XML to Markdown: lightweight information typing](https://redaction-technique.org/dita-xml-to-markdown-lightweight-information-typing) — applying DITA's information typing in Markdown.
- [Strong information typing without the XML overhead](https://redaction-technique.org/strong-information-typing-without-xml-overhead) — keeping the discipline of structure without XML tooling.
- [Distribute API reference from YAML across docs, and apps](https://redaction-technique.org/experimental-astro-api-docs) — a single structured source feeding multiple outputs.
