...
import StructuredVsUnstructuredDiagram from '../../../../components/diagrams/StructuredVsUnstructuredDiagram.astro';
import RawToJpegChainDiagram from '../../../../components/diagrams/RawToJpegChainDiagram.astro';
import DitaToDocbookToPdfChainDiagram from '../../../../components/diagrams/DitaToDocbookToPdfChainDiagram.astro';
import FrameMakerMigrationGanttDiagram from '../../../../components/diagrams/FrameMakerMigrationGanttDiagram.astro';
import FrameMakerRestructuringGanttDiagram from '../../../../components/diagrams/FrameMakerRestructuringGanttDiagram.astro';
import FrameMakerConversionTableDiagram from '../../../../components/diagrams/FrameMakerConversionTableDiagram.astro';
...
<CardGrid>
  <Card title='<span role="heading" aria-level="3">concept</span>'>
    Introduction or presentation of a concept.
  </Card>
  <Card title='<span role="heading" aria-level="3">task</span>'>
    Sequential, numbered, step-by-step procedure for performing a task.
  </Card>
  <Card title='<span role="heading" aria-level="3">reference</span>'>
...
<CardGrid>
  <Card title='<span role="heading" aria-level="3">Minimalist</span>'>
  ...
  <Card title='<span role="heading" aria-level="3">Comprehensive</span>'>
  ...
  <Card title='<span role="heading" aria-level="3">Consistent</span>'>
