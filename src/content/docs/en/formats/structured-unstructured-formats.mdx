...
The information contained in a technical document can be categorized according to its meaning. By default, [DITA XML](../cas-concrets-utilisation-de-dita-xml/) offers three basic types:
...
The aim of this procedure is to (see also [DITA XML tutorials](../veille/didacticiels-dita-xml-xsl-fo/) for setting up the publishing chain):
...
- [Case study: NuFirewall documentation](../cas-concret-documentation-de-nufirewall/)
