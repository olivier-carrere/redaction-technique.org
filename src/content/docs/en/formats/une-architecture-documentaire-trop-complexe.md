...
**DITA XML** enables significant productivity gains by reducing the source volume that the **technical editor** creates, translates and maintains. This productivity gain comes at the price of greater complexity.

While **DITA XML** projects are more *complex*, they are less *complex* than projects based on more traditional **FrameMaker** type formats. This is because **DITA XML** is a rational architecture. The **technical editor** is therefore faced with a predictable behavior of the tools he uses, far from the *tips and tricks* intended to get around the bugs or erratic functioning of heavier tools.
