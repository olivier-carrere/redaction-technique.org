...
NuFirewall's documentation, praised by the press as a notable strength of the product, was developed using [DITA XML](../formats-structures-et-non-structures/).
...
Leveraging conref enables DITA XML technical writers to significantly cut costs and publishing times, especially in multilingual contexts — an important consideration when [choosing formats and tools](../costs/formats-et-outils/).
:::
...
- [From document to modular document base](../du-document-a-la-base-documentaire-modulaire/)
- [A document architecture that's too complex?](../une-architecture-documentaire-trop-complexe/)
