...
- For a working example of documentation published alongside its machine-readable contract, see [this manual's own API](/en/about-the-api/): its `/schema.json` describes every endpoint, and the reference page adds the usage guidance the schema can't carry.
