...
:::tip[Template]
This is a **starting point to copy and adapt**, not a worked example. It's a specialized instance of the [reference article template](../reference-article-template/), shaped for one API endpoint per page.
:::
