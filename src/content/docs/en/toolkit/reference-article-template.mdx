...
:::tip[Template]
This is a **starting point to copy and adapt**, not a worked example. For a filled-in version, see the [API documentation template](../api-documentation-template/), which is a specialized case of this pattern.
:::
