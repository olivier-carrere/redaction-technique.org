...
A green pipeline shows that the site builds and its links resolve; it does not show that the documentation is ready to ship with a product release. Use the [release readiness checklist](../release-readiness-checklist/) as the release gate.
