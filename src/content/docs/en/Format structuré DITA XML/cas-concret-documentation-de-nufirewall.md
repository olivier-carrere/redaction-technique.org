...
slug: "/en/format-structuré-dita-xml/cas-concret-documentation-de-nufirewall/"
---
...
For example, you might want to reuse the phrase *Click OK.* However, you can't specify only the following code in the file containing the source *conref*:
...
![Conref placement on top-level XML node](/assets/conref-top-level.svg)
