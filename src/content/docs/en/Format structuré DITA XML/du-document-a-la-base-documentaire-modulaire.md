...
description: "The DITA XML structured authoring format offers a way of moving from the book model to the modular document base model"
---
...
**A single set of information, multiple output formats**.
...
**See also**
- Git: from file to content](../../process/reference/git-from-file-to-content)
