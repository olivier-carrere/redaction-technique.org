...
quadrantChart
    accTitle: Feature and complexity levels of text formats
    accDescr: Quadrant chart plotting reStructuredText, DocBook, and DITA XML by complexity and features. reStructuredText is low on both axes. DocBook is more complex but still limited in features. DITA XML is both complex and feature-rich.
    title Feature and complexity levels of text formats
    x-axis Low complexity --> High complexity
    y-axis Low features --> High features
    quadrant-1 Complex, feature-rich
    quadrant-2 Simple, feature-rich
    quadrant-3 Simple, limited features
    quadrant-4 Complex, limited features
