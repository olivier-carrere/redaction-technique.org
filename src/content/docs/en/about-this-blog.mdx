...
Not so long ago, the only tools capable of delivering quality PDF or HTML output relied on binary and proprietary formats that integrate poorly with development teams' version control systems.
...
- linked to a ticket in an issue tracker such as *Bugzilla* or *Trac*,
- validated by peers,
