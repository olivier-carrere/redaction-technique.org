...
Like the philosophy master in Molière's Bourgeois gentilhomme, a Python script can easily swap words in a sentence to say the same thing in a more convoluted way:
