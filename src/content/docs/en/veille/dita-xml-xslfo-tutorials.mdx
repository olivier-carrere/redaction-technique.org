...
The following tutorials will help the technical writer set up and use a free DITA XML authoring and publishing chain. For a broader overview of [structured and unstructured formats](../formats/formats-structures-et-non-structures/), including the rationale for choosing DITA XML, see the dedicated article.
...
- [Case study: NuFirewall documentation](../formats/cas-concret-documentation-de-nufirewall/)
- [Case studies in using DITA XML](../formats/cas-concrets-utilisation-de-dita-xml/)
