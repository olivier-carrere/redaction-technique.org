...
The following tutorials will help the technical writer set up and use a free DITA XML authoring and publishing chain. For a broader overview of [structured and unstructured formats](../formats/structured-unstructured-formats/), including the rationale for choosing DITA XML, see the dedicated article.
