...
1. Clone the [Git repository](../tech-writing-process/git-du-fichier-au-contenu/) of this blog's sources:
...
- We could implement a complete [conditional text solution](creer-des-documents-differents-a-partir-des-memes-sources-restructuredtext-jinja-texte-conditionnel/) with Boolean operators and all, thanks to the Jinja templating engine.
