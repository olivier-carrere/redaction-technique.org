...
description: "Discover quality control and validation processes for technical documentation: review cycles, style guides, terminology checks, and delivery gates before publication."
...
- [Gathering information](collecte-de-l-information/)
