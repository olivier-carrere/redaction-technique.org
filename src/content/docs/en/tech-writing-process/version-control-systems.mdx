...
gitGraph
    accTitle: Version history on the trunk
    accDescr: Git-style graph of the trunk showing a sequence of commits, with two of them tagged as published versions.
    commit tag: "version 1"
    commit
    commit tag: "version 2"
    commit`} />
