...
import TrunkVersionHistoryDiagram from '../../../../components/diagrams/TrunkVersionHistoryDiagram.astro';
...
<CardGrid>
  <Card title='<span role="heading" aria-level="3">Trunk</span>'>
  ...
  <Card title='<span role="heading" aria-level="3">Branch</span>'>
    Secondary repository created from the main version of the source code.
  </Card>
  <Card title='<span role="heading" aria-level="3">Tag</span>'>
