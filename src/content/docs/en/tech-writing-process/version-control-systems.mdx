...
- [Manage content in files, not databases](https://redaction-technique.org/manage-content-in-files-not-databases) — version-controlled files as the source of truth.
- [A web journey: from HTML to Git-based Markdown workflows](https://redaction-technique.org/web-journey-html-to-git-markdown) — adopting a version-controlled Markdown workflow.
- [Why hand-maintained InDesign files rot - and what docs-as-code does instead](https://redaction-technique.org/indesign-vs-docs-as-code) — the case for version control over binary layout files.
