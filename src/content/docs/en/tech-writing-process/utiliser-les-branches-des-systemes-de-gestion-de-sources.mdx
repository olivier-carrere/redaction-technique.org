...
description: "Use Git branches to manage parallel documentation projects, product variants, and translation workflows without conflicts — a practical guide for technical writers."
tags: [git, version-control, translation]
proofreading: IA
---
...
---
Source management systems offer the option of creating branches for a project. If a project splits into two incompatible projects, a branch is created from the main project. This allows the **technical writer** to manage various [translations](traduction/) of technical documentation.
...
The main difference between [Git](git-du-fichier-au-contenu/) and Subversion is the way they handle branches. Creating a branch in Subversion is equivalent to duplicating a directory. The files in these directories then evolve independently. In Git, however, branches can be created without duplicating data. Within the same local directory, you can use a command to switch between branches.
