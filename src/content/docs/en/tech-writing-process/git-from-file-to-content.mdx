...
5. When you receive validation for the first task, put your work in progress aside: `git stash`.
6. Merge the provisional branch with the master branch: `git merge my-branch`.
...
<Mermaid code={`%%{init: {"themeVariables": {"fontFamily": "IBM Plex Sans Variable, sans-serif", "git0": "{{parentStroke}}", "commitLabelColor": "{{childText}}", "commitLabelBackground": "{{childFill}}", "tagLabelBackground": "{{parentFill}}", "tagLabelBorder": "{{parentStroke}}", "tagLabelColor": "{{parentText}}"}}}%%
gitGraph
    accTitle: Interleaved commit history before rebase
    accDescr: Git history showing five commits alternating between text correction and synopsis changes, before reorganizing them with rebase.
    commit id: "Text 1"
    commit id: "Synopsis 1"
    commit id: "Text 2"
    commit id: "Synopsis 2"
    commit id: "Text 3"`} />
**Git history**
...
<Mermaid code={`%%{init: {"themeVariables": {"fontFamily": "IBM Plex Sans Variable, sans-serif", "git0": "{{parentStroke}}", "commitLabelColor": "{{childText}}", "commitLabelBackground": "{{childFill}}", "tagLabelBackground": "{{parentFill}}", "tagLabelBorder": "{{parentStroke}}", "tagLabelColor": "{{parentText}}"}}}%%
gitGraph
    accTitle: Grouped commit history after rebase
    accDescr: Git history showing two commits after rebase, one grouping all text correction changes and one grouping all synopsis changes.
    commit id: "Text"
    commit id: "Synopsis"`} />
**Git history**
