...
![Git commit history with interleaved synopsis and text correction commits before rebase reorganization](/assets/en/git-rebase-commits.svg)
**Git history**
...
![Git commit history after rebase grouping synopsis commits and text correction commits by type](/assets/en/git-rebase-commits-2.svg)
**Git history**
...
- [Version management systems - rustic but reliable](../version-management-systems/)
