...
If the program used does not lock open files, constant coordination is required between team members. [Version management systems](../version-management-systems/) address these limitations reliably.
