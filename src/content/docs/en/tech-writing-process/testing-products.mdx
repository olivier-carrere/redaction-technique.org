...
The technical writer cannot create useful documentation for the company's customers by merely [compiling information from various stakeholders](../collecte-de-l-information/). Serving as an advocate for users, the writer must test products in conditions similar to those encountered by users.
...
Initially, such an approach might seem unusual within the company and could face obstacles like setting up a test environment. However, it is usually only after customer feedback or product reviews that the value of this method is truly recognized. Then, technical documentation is appreciated not merely as a necessary task but as a genuine value addition — reflecting the broader goal of [technical communication](../costs/de-la-redaction-a-la-communication-technique/).
