...
The technical writer cannot create useful documentation for the company's customers by merely [compiling information from various stakeholders](../gathering-information/). Serving as an advocate for users, the writer must test products in conditions similar to those encountered by users.
