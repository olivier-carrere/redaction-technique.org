...
description: "Choosing the right repository for collaborative technical writing: compare shared drives, CMS, version control systems, and cloud platforms for documentation teams."
...
---
The most commonly used repository for storing computer files is the folder, or directory. While this is perfectly suited for managing files by a single user on their local hard drive, it quickly shows limitations for collaborative work — as detailed in [shared network directories](les-repertoires-reseau-partages-peu-adaptes-au-travail-de-groupe/).
...
If the program used does not lock open files, constant coordination is required between team members. [Version management systems](les-systemes-de-gestion-de-versions-rustiques-mais-fiables/) address these limitations reliably.
