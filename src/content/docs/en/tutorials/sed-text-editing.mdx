...
sed is a Unix command-line tool for editing many text files in one pass. It remains practical for one-off, repository-wide changes to text sources; in a Git repository, review the result with `git diff` before committing it. See [Git: from file to content](/en/tech-writing-process/git-from-file-to-content/).
:::
...
<SedBox lang="en" variant="echoSentence" />

Or:

<SedBox lang="en" variant="echoDeclaration" />

Or:

<SedBox lang="en" variant="geek1" />

Or else:

<SedBox lang="en" variant="geek2" />

Or else:

<SedBox lang="en" variant="geek3" />

Or else:

<SedBox lang="en" variant="geek4" />
...
<SedBox lang="en" variant="echoVariations" />
...
<SedBox lang="en" variant="echoScripts" />
