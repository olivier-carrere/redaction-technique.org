...
:::note[Case study]
A case study from outside technical documentation: a non-profit's photo archive, managed from conception to delivery. It illustrates the project-management side of the [documentation process](/en/process/): scoping, workflow design, tooling, and user-facing video tutorials.
:::
...
![GitHub diff view showing LaTeX typographic style modifications between document versions](/assets/latex-historique-forme-github.png)
**Viewing form modifications in GitHub**

Here’s the evolution of an excerpt from the compiled PDF:

![Visual diff comparing two compiled PDF versions of a LaTeX document showing layout and content changes](/assets/latex-diff-pdf.svg)
