...
description: "Set up a complete documentation platform on a Raspberry Pi 3: install Sphinx, generate PDF, HTML, and EPUB from reStructuredText, and manage content with Git."
...
- Present a <abbr title="Proof of Concept, demonstration of feasibility">POC</abbr> and use minimal resources to create, manage, and publish professional documentation. Most operations occur in text mode under Linux, though the same tools also work in graphical mode.
...
1. Clone the [Git repository](../../tech-writing-process/git-from-file-to-content/) of this blog's sources:
...
- We could implement a complete [conditional text solution](../conditional-text-jinja/) with Boolean operators and all, thanks to the Jinja templating engine.
