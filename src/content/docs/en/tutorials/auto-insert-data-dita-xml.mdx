...
This tutorial generates DITA XML topics from data with a Python script. It is useful when you maintain DITA content whose product data (names, versions) changes often; the same approach for reStructuredText is covered in [automatically insert data into a reStructuredText file](/en/tutorials/auto-insert-data-restructuredtext/).
:::
