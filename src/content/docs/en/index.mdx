...
<CardGrid stagger>
  <LinkCard title="Source format" href="https://redaction-technique.org/en/format-source" description="Learn the difference between source format and target format in technical writing, with examples from cooking and photography." />
</CardGrid>
