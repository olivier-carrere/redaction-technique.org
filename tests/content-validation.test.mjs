...
test('Live repository content validation across all 132 documentation pages', () => {
  const docsRoot = join(process.cwd(), 'src', 'content', 'docs');
  const allDocs = walkDocs(docsRoot);
  assert.equal(allDocs.length, 132, 'Must validate exactly 132 documentation pages');
