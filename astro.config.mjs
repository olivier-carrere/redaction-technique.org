...
export default defineConfig({
  ...
  redirects: {
    ...
    '/en/tech-writing-process/base-de-donnees-sql/':                                                                          '/en/tech-writing-process/cms-workflow-and-reliability/',
    ...
    '/en/tech-writing-process/les-repertoires-reseau-partages-peu-adaptes-au-travail-de-groupe/':                             '/en/tech-writing-process/which-repository-for-group-work/',
    ...
    '/fr/tech-writing-process/base-de-donnees-sql/':                                                                          '/fr/tech-writing-process/cms-workflow-and-reliability/',
    ...
    '/fr/tech-writing-process/les-repertoires-reseau-partages-peu-adaptes-au-travail-de-groupe/':                             '/fr/tech-writing-process/which-repository-for-group-work/',
    ...
    '/en/veille/didacticiels-dita-xml-xsl-fo/':                                                                             '/en/formats/',
    '/en/veille/expressions-regulieres-python/':                                                                             '/en/tutorials/python-regular-expressions/',
    '/en/veille/inserer-automatiquement-des-donnees-dans-un-fichier-restructuredtext/':                                      '/en/tutorials/auto-insert-data-dita-xml/',
    '/en/veille/inserer-automatiquement-des-donnees-sql-dans-un-fichier-restructuredtext/':                                  '/en/tutorials/auto-insert-data-dita-xml/',
    ...
    '/en/veille/raspberry-pi-plateforme-documentation/':                                                                     '/en/tutorials/',
    '/en/veille/sed-modifiez-votre-texte-sans-ouvrir-vos-fichiers/':                                                        '/en/tutorials/python-regular-expressions/',
    ...
    '/fr/veille/didacticiels-dita-xml-xsl-fo/':                                                                             '/fr/formats/',
    '/fr/veille/expressions-regulieres-python/':                                                                             '/fr/tutorials/python-regular-expressions/',
    '/fr/veille/inserer-automatiquement-des-donnees-dans-un-fichier-restructuredtext/':                                      '/fr/tutorials/auto-insert-data-dita-xml/',
    '/fr/veille/inserer-automatiquement-des-donnees-sql-dans-un-fichier-restructuredtext/':                                  '/fr/tutorials/auto-insert-data-dita-xml/',
    ...
    '/fr/veille/raspberry-pi-plateforme-documentation/':                                                                     '/fr/tutorials/',
    '/fr/veille/sed-modifiez-votre-texte-sans-ouvrir-vos-fichiers/':                                                        '/fr/tutorials/python-regular-expressions/',
    ...
    '/en/veille/auto-insert-data-restructuredtext/':                                                                                                              '/en/tutorials/auto-insert-data-dita-xml/',
    '/en/veille/auto-insert-sql-data-restructuredtext/':                                                                                                              '/en/tutorials/auto-insert-data-dita-xml/',
    ...
    '/en/veille/dita-xml-xsl-fo-tutorials/':                                                                                                              '/en/formats/',
    ...
    '/en/veille/raspberry-pi-documentation-platform/':                                                                                                              '/en/tutorials/',
    '/en/veille/sed-text-editing/':                                                                                                              '/en/tutorials/python-regular-expressions/',
    ...
    '/fr/veille/auto-insert-data-restructuredtext/':                                                                                                              '/fr/tutorials/auto-insert-data-dita-xml/',
    '/fr/veille/auto-insert-sql-data-restructuredtext/':                                                                                                              '/fr/tutorials/auto-insert-data-dita-xml/',
    ...
    '/fr/veille/dita-xml-xsl-fo-tutorials/':                                                                                                              '/fr/formats/',
    ...
    '/fr/veille/raspberry-pi-documentation-platform/':                                                                                                              '/fr/tutorials/',
    '/fr/veille/sed-text-editing/':                                                                                                              '/fr/tutorials/python-regular-expressions/',
    '/fr/veille/word-shuffling-python/':                                                                                                              '/fr/tutorials/',
    '/fr/tutorials/word-shuffling-python/':                                                                                                           '/fr/tutorials/',

    // 2026-09 content-audit archive — archived pages → closest surviving page
    '/en/tech-writing-process/shared-network-directories/':                                                                  '/en/tech-writing-process/which-repository-for-group-work/',
    '/fr/tech-writing-process/shared-network-directories/':                                                                  '/fr/tech-writing-process/which-repository-for-group-work/',
    '/en/tech-writing-process/sql-database/':                                                                                '/en/tech-writing-process/cms-workflow-and-reliability/',
    '/fr/tech-writing-process/sql-database/':                                                                                '/fr/tech-writing-process/cms-workflow-and-reliability/',
    '/en/tutorials/sed-text-editing/':                                                                                       '/en/tutorials/python-regular-expressions/',
    '/fr/tutorials/sed-text-editing/':                                                                                       '/fr/tutorials/python-regular-expressions/',
    '/en/tutorials/raspberry-pi-documentation-platform/':                                                                    '/en/tutorials/',
    '/fr/tutorials/raspberry-pi-documentation-platform/':                                                                    '/fr/tutorials/',
    '/en/tutorials/dita-xml-xsl-fo-tutorials/':                                                                              '/en/formats/',
    '/fr/tutorials/dita-xml-xsl-fo-tutorials/':                                                                              '/fr/formats/',
    '/en/tutorials/auto-insert-data-restructuredtext/':                                                                      '/en/tutorials/auto-insert-data-dita-xml/',
    '/fr/tutorials/auto-insert-data-restructuredtext/':                                                                      '/fr/tutorials/auto-insert-data-dita-xml/',
    '/en/tutorials/auto-insert-sql-data-restructuredtext/':                                                                  '/en/tutorials/auto-insert-data-dita-xml/',
    '/fr/tutorials/auto-insert-sql-data-restructuredtext/':                                                                  '/fr/tutorials/auto-insert-data-dita-xml/',
    ...
    '/en/tutorials/sed-text-modification/':                                                                                  '/en/tutorials/python-regular-expressions/',
    '/fr/tutorials/sed-text-modification/':                                                                                  '/fr/tutorials/python-regular-expressions/',
    '/en/tutorials/dita-xml-xslfo-tutorials/':                                                                               '/en/formats/',
    '/fr/tutorials/dita-xml-xslfo-tutorials/':                                                                               '/fr/formats/',
