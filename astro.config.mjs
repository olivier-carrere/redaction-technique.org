...
export default defineConfig({
  ...
  redirects: {
    ...
    '/en/veille/didacticiels-dita-xml-xsl-fo/':                                                                             '/en/tutorials/dita-xml-xslfo-tutorials/',
    ...
    '/en/veille/sed-modifiez-votre-texte-sans-ouvrir-vos-fichiers/':                                                        '/en/tutorials/sed-text-modification/',
    ...
    '/fr/veille/didacticiels-dita-xml-xsl-fo/':                                                                             '/fr/tutorials/dita-xml-xslfo-tutorials/',
    ...
    '/fr/veille/sed-modifiez-votre-texte-sans-ouvrir-vos-fichiers/':                                                        '/fr/tutorials/sed-text-modification/',
