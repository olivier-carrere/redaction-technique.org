...
Idéalement, tout le contenu peut être placé sous un référentiel unique, par exemple le logiciel de gestion de versions [Git](). Ceci en maximise la réutilisation, la cohérence et la qualité. Si le contenu est au format ou , par exemple, on peut exploiter au mieux les capacités de *single-sourcing* de ces formats pour le publier sous la forme appropriée.
