...
::: {.toctree hidden=""}
restructuration-du-contenu-framemaker table-de-conversion-framemaker-vers-dita-xml
:::

[^1]: propose une fonction d\'enregistrement au format , mais très imparfaite ; le XML qu\'elle produit peut servir de base à la création d\'une version , avec beaucoup d\'efforts... Sauf à maintenir deux versions du même contenu, le processus de migration de vers exige donc un arrêt temporaire des livraisons des nouvelles versions de la documentation ; il doit donc être soigneusement planifié.
