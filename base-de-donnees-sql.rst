...
Dans le cas d'un Content Management System de type Drupal, Joomla ou WordPress, le référentiel est une
...
le contenu. Cela peut justifier le choix de gérer le contenu sous-jacent du Content Management System
