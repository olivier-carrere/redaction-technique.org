...
Voici un cas original d'utilisation des *conref* |_| : imaginez que vous devez
...
Comment faire |_| ? Le filtrage à l'aide du mécanisme *ditaval* est conçu pour
...
comportant les informations confidentielles, les autres non |_| ? Adieu alors le
...
filtrage dans le fichier à traduire, vous avez résolu votre problème |_| : le
