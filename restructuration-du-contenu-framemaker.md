...
La partie automatisée d\'une migration de [FrameMaker]() vers consiste à appliquer une table de conversion entre les styles et les structures .

Un important travail de restructuration du document doit cependant être effectué en amont :
...
Ce n\'est qu\'une fois que sa chaîne est fiable et acceptée, voire attendue par les autres acteurs de l\'entreprise, que le peut envisager la migration.

Si vos documents sont disponibles en plusieurs langues, vous devez modifier les fichiers et effectuer la migration pour chaque langue. Si un projet de traduction dans une nouvelle langue se profile, mieux vaut effectuer la migration avant  !
