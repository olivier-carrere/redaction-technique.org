...
.. sidebar:: :awesome:`fa-bullhorn`
   ...
   doublons, des incohérences, un coût de mise à jour et de traduction élevé,
   et des retards de livraison. Le rédacteur technique dispose cependant d'autres
   modèles, plus efficaces.

Le format de rédaction structurée DITA XML propose de
...
.. figure:: graphics/documentation-modulaire.svg
...
mise à jour et traduction du contenu d'entreprise. De plus, le rédacteur technique
