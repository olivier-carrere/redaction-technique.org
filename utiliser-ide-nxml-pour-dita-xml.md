...
6.  Ouvrez un fichier de contenu (`.dita`{.interpreted-text role="file"}) avec Emacs. La syntaxe apparaît en couleurs. Les endroits où le schéma n\'est pas respecté sont soulignés en rouge.
