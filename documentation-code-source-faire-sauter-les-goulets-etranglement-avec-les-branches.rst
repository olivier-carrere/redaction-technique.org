...
Imaginons le scénario de travail suivant |_| :
...
Comment faire sauter ce goulot d'étranglement |_| ? C'est (relativement) simple |_| :
...
#. Par défaut, vous travaillez sur la branche *master*. Votre espace de travail
   ...
   validation.
#. Créez une nouvelle branche |_| : *git checkout -b ma-branche*.
#. *Committez* vos modifications sur la nouvelle branche |_| : *git add mes-fichiers*,
...
#. Vous repassez sur la branche master *git checkout master* et passez à votre
   ...
   sur la branche provisoire |_| : *git checkout ma-branche* et faites un nouveau
...
#. Lorsque vous recevez la validation de la première tâche, vous mettez votre
   travail en cours de côté |_| : *git stash*.
#. Vous fusionnez la branche provisoire avec la branche master |_| : *git merge
   ma-branche*.
#. Vous récupérez votre travail en cours |_| : *git stash pop*.
